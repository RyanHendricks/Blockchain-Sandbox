<?php
	...
	{
		$config=array();
		$config[getenv("CHAIN_NAME")]["name"] = getenv("DISPLAY_NAME");
		$config[getenv("CHAIN_NAME")]["rpchost"] = getenv("RPC_HOST");
		$config[getenv("CHAIN_NAME")]["rpcport"] = getenv("RPC_PORT");
		$config[getenv("CHAIN_NAME")]["rpcuser"] = getenv("RPC_USER");
		$config[getenv("CHAIN_NAME")]["rpcpassword"] = getenv("RPC_PASSWORD");
