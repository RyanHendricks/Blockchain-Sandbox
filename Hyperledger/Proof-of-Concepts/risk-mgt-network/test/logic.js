...
describe('#'+NS, function() {
    ...
    before(function() {
        ...
        .then(function() {
            ...
            return businessNetworkConnection.connect('defaultProfile', 'risk-mgt-network', 'admin', 'Xurw3yU9zI0l');
        });
    });
    ...
    describe('ChangeAssetValue()', function() {
        ...
        it('should change the value property of Asset to newValue', () => {
            ...
            // create a user
            var user = factory.newResource(NS, 'User', 'Ryan Hendricks');
